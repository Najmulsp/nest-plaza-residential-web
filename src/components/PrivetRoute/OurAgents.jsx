const OurAgents = () => {
  return (
    <div className="container justify-around grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mx-auto my-10">
      <div className="flex flex-col justify-center w-96 py-2 shadow-lg rounded-xl sm:px-12 dark:bg-gray-100 dark:text-gray-800">
        <img
          src="https://i.ibb.co/C8g2PmY/agents-1.jpg"
          alt=""
      ...
      <div className="flex flex-col justify-center w-96 py-2 shadow-md rounded-xl sm:px-12 dark:bg-gray-100 dark:text-gray-800">
        ...
        <div className="space-y-4 text-center divide-y dark:divide-gray-300">
          <div className="my-2 space-y-1">
            <h2 className="text-xl font-semibold sm:text-2xl">Tyson Tyon</h2>
            <p className="px-5 text-xs sm:text-base dark:text-gray-600">
      ...
      <div className="flex flex-col justify-center w-96  py-2 shadow-md rounded-xl sm:px-12 dark:bg-gray-100 dark:text-gray-800">
        ...
        <div className="space-y-4 text-center divide-y dark:divide-gray-300">
          <div className="my-2 space-y-1">
            <h2 className="text-xl font-semibold sm:text-2xl">Evan Jenkins</h2>
            <p className="px-5 text-xs sm:text-base dark:text-gray-600">
              New York Home Improvement Pros
            </p>
          </div>
          <div className="flex justify-center pt-2 space-x-4 align-center">
            <a
      ...
      <div className="flex flex-col justify-center w-96  py-2 shadow-md rounded-xl sm:px-12 dark:bg-gray-100 dark:text-gray-800">
        ...
        <div className="space-y-4 text-center divide-y dark:divide-gray-300">
          <div className="my-2 space-y-1">
            <h2 className="text-xl font-semibold sm:text-2xl">Kit Stiphen</h2>
            <p className="px-5 text-xs sm:text-base dark:text-gray-600">
      ...
      <div className="flex flex-col justify-center w-96   shadow-md rounded-xl sm:px-12 dark:bg-gray-100 dark:text-gray-800">
        ...
        <div className="space-y-4 text-center divide-y dark:divide-gray-300">
          <div className="my-2 space-y-1">
            <h2 className="text-xl font-semibold sm:text-2xl">Jerry Lower</h2>
            <p className="px-5 text-xs sm:text-base dark:text-gray-600">
      ...
      <div className="flex flex-col justify-center w-96 py-2  shadow-md rounded-xl sm:px-12 dark:bg-gray-100 dark:text-gray-800">
        ...
        <div className="space-y-4 text-center divide-y dark:divide-gray-300">
          <div className="my-2 space-y-1">
            <h2 className="text-xl font-semibold sm:text-2xl">Thomas Jhonson</h2>
            <p className="px-5 text-xs sm:text-base dark:text-gray-600">
